function [SleepStateEpisodes] = StatesToEpisodes_km(SleepState,basePath,filename)
...
if exist('basePath','var')
    ...
    bz_sleepstateepisodespath = fullfile(basePath,[filename,'.SleepStateEpisodes.states.mat']);
